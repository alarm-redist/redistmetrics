...
RcppExport SEXP _rict_log_st_map(SEXP gSEXP, SEXP districtsSEXP, SEXP countiesSEXP, SEXP n_distrSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _rict_n_removed(SEXP gSEXP, SEXP districtsSEXP, SEXP n_distrSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Graph& >::type g(gSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_rict_log_st_map", (DL_FUNC) &_rict_log_st_map, 4},
    {"_rict_n_removed", (DL_FUNC) &_rict_n_removed, 3},
