...
phasecommute <- function(plans, current, pop, schools, commute_times, ndists) {
    .Call(`_redistmetrics_phasecommute`, plans, current, pop, schools, commute_times, ndists)
}

maxcommute <- function(plans, schools, commute_times, ndists) {
    .Call(`_redistmetrics_maxcommute`, plans, schools, commute_times, ndists)
}
