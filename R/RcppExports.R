...
phasecommute <- function(plans, current, pop, schools_idx, commute_times, ndists) {
    .Call(`_redistmetrics_phasecommute`, plans, current, pop, schools_idx, commute_times, ndists)
}

maxcommute <- function(plans, schools_idx, commute_times, ndists) {
    .Call(`_redistmetrics_maxcommute`, plans, schools_idx, commute_times, ndists)
}
