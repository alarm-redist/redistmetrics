...
phasecommute <- function(plans, current, pop, commute_times, ndists) {
    .Call(`_redistmetrics_phasecommute`, plans, current, pop, commute_times, ndists)
}

maxcommute <- function(plans, commute_times, ndists) {
