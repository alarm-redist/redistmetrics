...
$$\textrm{Boyce-Clark} = \sum_{i=1}^{16}\abs{\frac{r_{i}}{\sum_{i=1}^{16} r_i} * 100 - \frac{100}{n}}$$
...
$$ Fraction Kept = \frac{E(a) - E_\pi(a)}{E(a)}$$
...
$$ Log Spanning Tree = \textrm{log}(n_st)$$
